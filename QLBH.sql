...
WHERE KHACHHANG.MAKH = HOADON.MAKH AND HOADON.NGHD = '1/7/2007';
...
AND NUOCSX = 'Trung Quoc' OR NGHD = '1/1/2017'
...
FROM SANPHAM
WHERE MASP NOT IN (SELECT CTHD.MASP
					FROM CTHD, HOADON
...
SELECT NUOCSX, MIN(GIA) AS MIN, MAX(GIA) AS MAX, AVG(GIA) AS AVG
FROM SANPHAM
GROUP BY NUOCSX
...
SELECT MASP, COUNT(MASP) AS TONGSOLUONG
FROM CTHD, HOADON
